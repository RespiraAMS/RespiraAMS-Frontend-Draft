...
import { MOCK_PATHOGENS, type PathogenItem } from "../types";
	...
	return (
		<>
			<Table>
				<TableHeader>
					<TableRow>
						<TableHead className="w-[280px]">Tên tác nhân gây bệnh</TableHead>
					...
					{items.length === 0 ? (
						<TableRow>
							<TableCell colSpan={3} className="h-32 text-center text-muted-foreground">
								Không tìm thấy tác nhân gây bệnh nào.
							</TableCell>
						</TableRow>
					) : (
						items.map((item) => (
							<TableRow key={item.id}>
								...
								<TableCell className="align-middle">
									<span className="text-foreground whitespace-normal wrap-break-word line-clamp-2">
										{item.description}
									</span>
								</TableCell>
